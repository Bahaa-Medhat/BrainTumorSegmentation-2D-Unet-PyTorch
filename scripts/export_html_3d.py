"""Export brats2020_singlestage_3d.ipynb to HTML.

Usage:
    python scripts/export_html_3d.py                  # default output next to notebook
    python scripts/export_html_3d.py -o output.html   # custom output path
"""
import subprocess
import sys
import os
...
NOTEBOOK = os.path.join(REPO_ROOT, "brats2020_singlestage_3d.ipynb")
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Export 3D single-stage notebook to HTML")
    parser.add_argument("-o", "--output", default=None, help="Output HTML path")
    args = parser.parse_args()

    output = args.output or os.path.join(REPO_ROOT, "brats2020_singlestage_3d.html")
